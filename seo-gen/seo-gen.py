...
async def main():
    ...
    target_persona = Prompt.ask("[cyan]ターゲットペルソナを入力してください（例：庭づくり初心者, 子供がいる家庭）[/cyan]", default="庭づくり初心者")

    target_length_str = Prompt.ask("[cyan]目標文字数を入力してください（任意、数値のみ）[/cyan]", default="2000")
    target_length = None
    ...
    num_research_queries_str = Prompt.ask("[cyan]リサーチで使用する検索クエリ数を入力してください[/cyan]", default="3") # デフォルトを3に減らしてテスト
